...
#include <memory>
#include "../wndManger/WidgetBase.h"
...
QT_MOC_LITERAL(1, 11, 13), // "selectStation"
QT_MOC_LITERAL(2, 25, 0) // ""

    },
    "WidgetBase\0selectStation\0"
};
...
void WidgetBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WidgetBase *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->selectStation(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WidgetBase::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WidgetBase::selectStation)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject WidgetBase::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_WidgetBase.data,
    qt_meta_data_WidgetBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };

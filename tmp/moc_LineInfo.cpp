...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_LineInfo_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject LineInfo::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_LineInfo.data,
    qt_meta_data_LineInfo,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *LineInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LineInfo.stringdata0))

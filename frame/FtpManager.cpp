...
//    m_ftp->setHostPort("192.16.2.193", 21);
//    m_ftp->setUserInfo("root", "WYXWJMM@2021");
//    QUrl url("ftp://192.16.2.193/home/set-net.log");
//    url.setPort(21);//服务器端口号，一般没有被更改过的默认端口号为21
//    url.setUserName("root");//服务器登录用户名
//    url.setPassword("WYXWJMM@2021");

    m_pUrl.setPath(path);
    qDebug() << "上传路径：" << m_pUrl.toString();
